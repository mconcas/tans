...
void XtrapolateZeta(TH1F &Rough, TH1F &Fine, ZReal_t &ZetaFound)
{
   ...
   // Find 1st Maximum (bin) in Rough, starting from the left.
   ...
   // Find 2nd Maximum (bin) in Rough, starting from the right.
   do {
   ...
   if(SecondMaxRoughBin-FirstMaxRoughBin<2) {
      ...
      do {
         ...
         Iterator2--;
      } while(SecondMaxFine<FirstMaxFine || Fine.GetBinLowEdge(SecondMaxFineBin)
         >=UpLimit);
