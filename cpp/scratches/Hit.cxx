   ...
   Double_t YO, Double_t Radius ) 
{
      ...
      const Double_t t=(-(XO*cosphi+YO*sinphi)
            ...
            +YO*sinphi)-XO*XO-YO*YO+Radius*Radius))/sintheta;
   ...
   Double_t Radius, Int_t Ide, Int_t Layerno ) 
{
      ...
      Hit *OnCyl=new Hit( xO+t*Direct.GetDirCos1(),
                          yO+t*Direct.GetDirCos2(),
                          zO+t*Direct.GetDirCos3(),
                          Layerno, Ide );
                       ...
                       Double_t P, Int_t Z, Double_t Beta ) 
{
   if ( Multiscat ) {
      ...
      // operation.
      const Double_t ThetaZero=( 13.6/( Beta*P ))*Z*\
         TMath::Sqrt( Width/X_0 )*( 1+0.038*TMath::Log( Width/X_0 ) );
   ...
   if( theta==0 || TMath::Abs( theta )==TMath::Pi() ) {
      ...
      // Returned item.
      Hit *OnCyl=new Hit( fX+t*Direct.GetDirCos1(),
                          fY+t*Direct.GetDirCos2(),
                          fZ+t*Direct.GetDirCos3(),
                          Layno, fIdnumber );
