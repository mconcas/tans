...
Hit *Hit::HitOnCylFromVertex(Vertice fOrigin, Double_t fTheta,
   ...
   const Double_t t=(-(xO*cosphi+yO*sinphi)+TMath::Sqrt((xO*cosphi+yO*sinphi)*(xO*cosphi+yO*sinphi)-xO*xO-yO*yO+fRadius*fRadius))/TMath::Abs(sintheta); 
   ...
   Hit *OnCyl=new Hit(hitname,fShape,fLayno,vertname, coord[0], coord[1],
      coord[2]);
   return OnCyl;
}
